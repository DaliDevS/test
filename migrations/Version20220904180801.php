 ...
 */
final class Version20220904180801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entity_result ADD draw_index_id INT DEFAULT NULL, DROP draw_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entity_result ADD draw_id INT NOT NULL, DROP draw_index_id');
